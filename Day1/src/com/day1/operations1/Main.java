...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Addition of numbers is"+operations2.addition(operations2.getNumber1(), operations2.getNumber2()));
		System.out.println("Subtraction of numbers is"+operations2.subtraction(operations2.getNumber1(), operations2.getNumber2()));
		System.out.println("multiplication of numbers is"+operations2.multiplication(operations2.getNumber1(), operations2.getNumber2()));
		System.out.println("division of numbers is"+operations2.division(operations2.getNumber1(), operations2.getNumber2()));
		...
		System.out.println("Average of three numbers is "+operations345.average(operations345.getNumber1(), operations345.getNumber2(), operations345.getNumber3()));
		System.out.println("Swapping 1st number and 2nd number");
		System.out.println("Valiues of number1 and number2 before swapping are"+operations345.getNumber1()+" "+operations345.getNumber2());
		operations345.SwapOfNumbers(operations345.getNumber1(), operations345.getNumber2(),operations345);
		System.out.println("Valiues of number1 and number2 after swapping are"+operations345.getNumber1()+" "+operations345.getNumber2());
		...
		System.out.println("Ascii value of the charecter "+operation6.getCharecter()+" is" + " "+ operation6.asciiValue(operation6.getCharecter()));
			
		Operation7 operation7 = new Operation7();
		System.out.println("Fizz buzz program output is");
		//String array[] = operation7.fizzBuzz(100);
		int temp = 0;
